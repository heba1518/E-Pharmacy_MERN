  ...
  return (
    <div className="container mx-auto">
      <div className="max-w-full relative mt-6 mb-10">
        ...
        {/* Shop Details */}
        <div className="bg-teal-500 sm:bg-blue-600 bg-opacity-90 sm:bg-opacity-40 py-4 lg:w-4/12 md:py-4 lg:py-12 px-4 lg:absolute left-0 top-0 text-white min-h-80 flex flex-col items-center justify-center text-sans">
