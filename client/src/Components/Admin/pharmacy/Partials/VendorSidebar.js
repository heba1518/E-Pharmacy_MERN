...
const VendorSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  let r = localStorage.getItem("newPharmacy");
  let pharmacy = JSON.parse(r)
  return (
      ...
      >
        ...
        <div className="flex flex-col items-center flex-shrink-0 pb-4">
          <img
            ...
            src={Img}
          />
          {/* {"shopName":"Gemy","name":"Gemy","email":"jfkigm@gmail.com","phone":"01085966774","request":false,"date":"2024-06-29","banner":"https://i.ibb.co/zR760Cw/Image-2.jpg","address":"Elhwatem, undefined","password":"1","hasOwnDelivery":true} */}
          <h2 className="font-display text-xl font-semibold tracking-wide text-teal-50 title-font text-center">
            {pharmacy.shopName} Pharmacy
          </h2>
