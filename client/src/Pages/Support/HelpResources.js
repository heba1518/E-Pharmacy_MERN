      ...
      <Fragment>
        ...
        <div className="p-6 overflow-hidden md:container md:mx-auto">
          ...
          <div className="container p-5 border-2">
            ...
            <p>
              We at Enaya are bound to honour all orders that come
              ...
              Text messages and others. However, in all cases Enaya
            ...
            <p>
              We at Enaya take utmost effort to deliver the products
              ...
              user account in Enaya which can be used for subsequent
